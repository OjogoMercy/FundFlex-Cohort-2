...
import CustomButton from '../components/CustomButton';
 ...
 const VerifyCode2 = ({navigation}) => {
    ...
    <View style={general.container}>
     ...
     <CustomButton title='Submit' buttonStyle={{width:'60%',alignSelf:'center',marginTop:30}} onPress={() => navigation.navigate('Profile')}/>
    </View>
    
    )};
    export default VerifyCode2;
